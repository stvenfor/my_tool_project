...
def main() -> None:
    ...
    parser.add_argument("--video", default="modules/dance-remake/work/reference/source.mp4")
    parser.add_argument("--output", default="modules/dance-remake/work/reference/beat_map.json")
