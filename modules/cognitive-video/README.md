...
Re-voice only: `npm run cognitive:voice -- --config modules/cognitive-video/work/<id>/config.json`

## Output

- `modules/cognitive-video/work/{id}/output/final.mp4`
- `modules/cognitive-video/work/{id}/storyboard.json`
- `modules/cognitive-video/work/{id}/douyin-video.json`
...
npm run cognitive:publish -- --config modules/cognitive-video/work/middle-class-exit/douyin-video.json --dry-run
```
