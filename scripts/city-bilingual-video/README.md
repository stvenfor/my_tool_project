...
npm run city-bilingual:pipeline -- --config _city-bilingual/output/xian/city.config.json
```
...
Copy [`config.template.json`](config.template.json) to `_city-bilingual/output/{city}/city.config.json` and edit:
...
- `_city-bilingual/output/xian/final.mp4`
- `_city-bilingual/output/xian/storyboard.json`
