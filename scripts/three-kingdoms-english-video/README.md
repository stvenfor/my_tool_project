...
npm run tk-english:parity -- --reference _three-kingdoms-english/reference/yijia-xuchang/reference/source.mp4 --replica _three-kingdoms-english/output/yijia-xuchang/final.mp4 --subtitles _three-kingdoms-english/output/yijia-xuchang/subtitles.json
```
...
见 [`_three-kingdoms-english/manual/yijia-xuchang/SOP.md`](../../_three-kingdoms-english/manual/yijia-xuchang/SOP.md) 与 `storyboard_prompts.json`。

将即梦导出的 `S00.mp4`…`S12.mp4` 放入 `manual_clips/` 后重新跑 pipeline。

## Output

- `_three-kingdoms-english/output/yijia-xuchang/final.mp4`
- `_three-kingdoms-english/output/yijia-xuchang/douyin-video.json`
