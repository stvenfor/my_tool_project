...
from lib import CAT_DRAMA_ROOT, COGNITIVE_ROOT, load_json, run, save_json, write_project_config  # noqa: E402
from modes.common import export_douyin, render_storyboard  # noqa: E402

sys.path.insert(0, str(COGNITIVE_ROOT))
from build_storyboard import prepare_ambient_bgm  # noqa: E402
