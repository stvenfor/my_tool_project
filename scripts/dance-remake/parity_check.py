...
def load_beat_map(root: Path) -> dict:
    path = root / "_dance-remake/reference/beat_map.json"
    if path.exists():
...
def main() -> None:
    ...
    parser.add_argument("--reference", default="_dance-remake/reference/source.mp4")
    parser.add_argument("--replica", default="_dance-remake/output/final.mp4")
    parser.add_argument("--output", default="_dance-remake/output/parity_report.json")
