...
- User references `modules/cognitive-video/work/` or `modules/cognitive-video/`
...
| LLM script | `npm run cognitive:script -- --config modules/cognitive-video/work/<id>/config.json --llm` |
| Whisper align | `npm run cognitive:align -- --config modules/cognitive-video/work/<id>/config.json` |
| Publish | `npm run cognitive:publish -- --config modules/cognitive-video/work/<id>/douyin-video.json` |
| Batch | `npm run cognitive:batch -- --all` |

## Work dir

`modules/cognitive-video/work/{topic-id}/`
...
2. Copy `modules/cognitive-video/config.template.json` → `modules/cognitive-video/work/{id}/config.json`
...
See [modules/cognitive-video/README.md](../../modules/cognitive-video/README.md) for full docs.
